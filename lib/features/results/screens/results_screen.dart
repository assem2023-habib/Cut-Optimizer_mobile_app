...
class ResultsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final wastePercentage = ResultsCalculator.calculateWastePercentage(groups, remaining);
    final totalArea = ResultsCalculator.calculateTotalArea(groups, remaining);
    final usedArea = ResultsCalculator.calculateUsedArea(groups, remaining);
        ...
        child: Column(
          ...
          children: [
            ...
            if (remaining.isNotEmpty)
              RemainingPieces(remaining: remaining),
